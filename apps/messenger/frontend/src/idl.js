/**
 * idl.js — Candid IDL factory per Sovereign Messenger.
 *
 * Identico alla fabbrica perché il Messenger usa tutti i blocchi.
 * Se un'app usa meno blocchi, questo file includerebbe solo quei metodi.
 */
